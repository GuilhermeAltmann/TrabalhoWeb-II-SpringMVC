...
<h2>Edição da disciplina "${disciplina.nome}"</h2>
<c:url var="actionEditar" value="/disciplinas/alterar"></c:url>
<form:form action="${actionEditar}" method="post" modelAttribute="disciplina" cssClass="bs-component">
