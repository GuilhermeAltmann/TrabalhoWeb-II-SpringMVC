...
<h2>Inserção novo professor</h2>
<c:url var="actionAdicionar" value="/professores/adicionar"></c:url>
<form:form action="${actionAdicionar}" method="post" modelAttribute="professor" cssClass="bs-component">
