...
<h2>Inserção novo aluno</h2>
<c:url var="actionAdicionar" value="/alunos/adicionar"></c:url>
<form:form action="${actionAdicionar}" method="post" modelAttribute="aluno" cssClass="bs-component">
