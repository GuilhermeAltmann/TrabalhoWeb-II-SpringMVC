...
<h2>Alteração do aluno "${aluno.id}"</h2>

<c:url var="actionAlterar" value="/alunos/alterar"></c:url>
<form:form action="${actionAlterar}" method="post" modelAttribute="aluno" cssClass="bs-component">
	<div class="col-lg-4 col-md-6 col-xs-12">
		...
		<div class="form-group">
			...
			<form:errors path="matricula" cssClass="invalid-feedback"></form:errors>
		</div>
		<div class="form-group">
