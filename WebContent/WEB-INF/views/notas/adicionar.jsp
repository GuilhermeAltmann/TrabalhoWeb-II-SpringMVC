...
<h2>Inserção nova nota</h2>
<c:url var="actionAdicionar" value="/notas/adicionar"></c:url>
<form:form action="${actionAdicionar}" method="post" modelAttribute="nota" cssClass="bs-component">
